...
let live1xBetdata = () => {
  ...
  for (let div of divs) {
    let team1 =
      div.children[0].children[0].children[0].children[1].firstChild.children[0]
        .firstChild.innerText;
    let team2 =
      div.children[0].children[0].children[0].children[1].firstChild.children[1]
        .firstChild.innerText;
    let time =
      div.children[0].children[0].children[1].children[0].children[1]
...
let upcoming22BetData = () => {
  ...
  for (let div of divs) {
    ...
    let gameInfo = {
      ...
      w2,
      id,
      time: { date: time[0], starts: time[1] },
    };
